...
if [ $TASK == 'udpos' ]; then
  LANGS=("af" "ar" "bg" "de" "el" "en" "es" "et" "eu" "fa" "fi" "fr" "he" "hi" "hu" "id" "it" "ja" "kk" "ko" \
  "mr" "nl" "pt" "ru" "ta" "te" "th" "tl" "tr" "ur" "vi" "yo" "zh" "lt" "pl" "uk" "ro")
elif [ $TASK == 'panx' ]; then
  LANGS=("ar" "he" "vi" "id" "jv" "ms" "tl" "eu" "ml" "ta" "te" "af" "nl" "en" "de" "el" "bn" "hi" "mr" "ur" \
  "fa" "fr" "it" "pt" "es" "bg" "ru" "ja" "ka" "ko" "th" "sw" "yo" "my" "zh" "kk" "tr" "et" "fi" "hu" "qu" "pl" \
  "uk" "az" "lt" "pa" "gu" "ro")
