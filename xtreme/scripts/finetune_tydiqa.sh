...
MODEL_PATH=$OUT_DIR/${TASK}/in_language/${LANG}_${MODEL}_LR${LR}_maxsteps${MAX_STEPS}_maxlen${MAXL}_batchsize${BATCH_SIZE}_gradacc${GRAD_ACC}
mkdir -p $MODEL_PATH
