...
from .multilingual import CanineMultilingualAdapterModel
from .canine import CanineAdapterModel
from .tydiqa_utils import QAWithSubwordPredictionOutput
...
class CanineForQAWithSubwordPrediction(CanineForQuestionAnswering):
    def __init__(self, config, *args, **kwargs):
        ...
        self.subword_classifier = nn.Linear(config.hidden_size, 3)
        self.num_subword_labels = 3
...
class CanineAdapterForQAWithSubwordPrediction(CanineForQAWithSubwordPrediction):
    def __init__(self, config, *args, **kwargs):
        ...
        self.canine = CanineAdapterModel(
            ...
            adapter_location=kwargs['adapter_location']
        )
        self.qa_outputs = nn.Linear(config.hidden_size, config.num_labels)
