...
try:
    ...
    import third_party.processors.tydi_special_codepoints as special_codepoints
    import third_party.processors.tydi_data as data
    import third_party.processors.tydi_tokenization_interface as tydi_tokenization_interface
