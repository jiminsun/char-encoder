...
MODEL_CLASSES = {
    ...
    "canine": (CanineConfig, CanineForTokenClassification, CanineTokenizer),
}
...
def main():
    ...
    if args.do_train:
        run_name += ['train', args.train_langs]
    if args.do_eval or args.do_predict:
        run_name += ['eval', args.predict_langs]
    ...
    if args.model_name_or_path.startswith('google/'):
        ...
        run_name.append(args.model_name_or_path)
